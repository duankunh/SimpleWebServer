...
term : term.o
	${CC} ${CFLAGS} -o $@ $^  
tt1 : tt1.o wrapsock.o progtable.o ws_helpers.o process_request.o
	${CC} ${CFLAGS} -o $@ $^
tt2 : tt2.o wrapsock.o progtable.o ws_helpers.o process_request.o
	${CC} ${CFLAGS} -o $@ $^
...
tt1.o : wrapsock.h ws_helpers.h
tt2.o : wrapsock.h ws_helpers.h
